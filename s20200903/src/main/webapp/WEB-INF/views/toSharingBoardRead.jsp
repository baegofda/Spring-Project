            ...
            <div class="article__sharing-board-read">
                ...
                <div class="sharing-board-read__info-container">
                    <div class="sharing-board-read__info">
                        <a href="#none"
                            ><div class="sharing-board-read__name">
                                닉네임
                            </div></a
                        >
                        <p class="sharing-board-read__address">
                            서울특별시 송파구 석촌동
                        </p>
                    </div>
                    <div class="sharing-board-read__sweet-cotainer">
                        <div
                            class="sharing-board-read__sweet sweet-cotainer"
                        ></div>
                        <div class="sharing-board-read__text">당도</div>
                    </div>
                </div>
                <div class="sharing-board-read__content">
                    <h1 class="sharing-board-read__content--title">
                        제목이 들어갑니다.
                    </h1>
                    ...
                    <div class="sharing-board-read__content--price">
                        무료나눔
                    </div>
                    ...
                    <div
                        class="sharing-board-read__content--counts picks-container"
                    >
                        <img
                            class="picks-ico"
                ...
                <div class="sharing-board-read__btn-container">
                    <a href="#none"
                        ><div class="sharing-board-read__list list-btn">
                            목록
                        </div></a
                    >
                    <input
                        class="sharing-board-read__delete"
                        type="button"
                        value="삭제"
                    />
                    <input
                        class="sharing-board-read__update"
                        type="button"
                        value="수정"
                    />
                </div>
