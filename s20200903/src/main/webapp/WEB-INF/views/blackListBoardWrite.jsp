    ...
    <body>
        ...
        <article class="article">
            <div class="article__black-list-board-write">
                <div class="black-list-board-write__info">
                    <div class="black-list-board-write__location">
                        <label
                            class="black-list-board-write__location--label"
                            for="black-list-board-write__location--input"
                            >활동 지역</label
                        >
                        <input
                            class="black-list-board-write__location--input"
                            type="text"
                            readonly
                            value="회원 주소값 넣기"
                        />
                ...
                <div class="black-list-board-write__image">
                    <div class="black-list-board-write__image--title">
                        사진 첨부
                    </div>
                ...
                <div class="black-list-board-write__title">
                    <textarea
                        class="black-list-board-write__title--textarea"
                ...
                <div class="black-list-board-write__content">
                    <textarea
                        class="black-list-board-write__content--textarea"
                ...
                <div class="black-list-board-write__btn-container">
                    <a href="#none"
                        ><div class="black-list-board-write__list list--btn">
                            돌아가기
                        </div></a
                    >
                    <input
                        class="black-list-board-write__submit"
                        type="button"
                        value="작성하기"
                    />
                </div>
