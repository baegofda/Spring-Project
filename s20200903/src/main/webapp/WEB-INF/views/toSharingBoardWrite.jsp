        ...
        <article class="article">
            <div class="article__sharing-board-write">
                <div class="sharing-board-write__sort">
                    <select
                        class="sharing-board-write__category"
                        name="sharing-board-write__category--code"
                        required
                    >
                ...
                <div class="sharing-board-write__info">
                    <div class="sharing-board-write__location">
                        <label
                            ...
                            for="sharing-board-write__location--input"
                            >활동 지역</label
                        >
                        <input
                            class="sharing-board-write__location--input"
                            type="text"
                            readonly
                            value="회원 주소값 넣기"
                        />
                    ...
                    <div class="sharing-board-write__price">
                        <label
                            class="sharing-board-write__price--label"
                            for="sharing-board-write__price--input"
                            >거래 가격</label
                        >
                        <input
                            class="sharing-board-write__price--input"
                            type="text"
                            readonly
                            value="무료나눔"
                        />
                ...
                <div class="sharing-board-write__title">
                    <textarea
                        class="sharing-board-write__title--textarea"
                ...
                <div class="sharing-board-write__content">
                    <textarea
                        class="sharing-board-write__content--textarea"
                ...
                <div class="sharing-board-write__btn-container">
                    <a href="#none"
                        ><div class="sharing-board-write__list list--btn">
                            돌아가기
                        </div></a
                    >
                    <input
                        class="sharing-board-write__submit"
                        type="button"
                        value="작성하기"
                    />
                </div>
