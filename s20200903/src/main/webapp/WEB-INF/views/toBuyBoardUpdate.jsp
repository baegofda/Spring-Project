            ...
            <div class="article__buy-board-update">
                ...
                <div class="buy-board-update__sort">
                    <select
                        ...
                        name="buy-board-update__category--code"
                        required
                    >
                    ...
                    <select
                        class="buy-board-update__category category-status"
                        name="buy-board-update__category--status"
                        required
                    >
                    ...
                    <input
                    class="buy-board-update__category--text category-input"
                    type="text"
...
내용가져오기</textarea
                ...
                <div class="buy-board-update__btn-container">
                    <a href="#none"
                        ><div class="buy-board-update__list list--btn">
                            돌아가기
                        </div></a
                    >
                    <input
                        class="buy-board-update__submit"
                        type="button"
                        value="수정하기"
                    />
                </div>
