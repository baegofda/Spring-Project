        ...
        <article class="article">
            <div class="article__sharing-board-update">
                ...
                <div class="sharing-board-update__sort">
                    <select
                        class="sharing-board-update__category"
                        name="sharing-board-update__category--code"
                        required
                    >
                    ...
                    <select
                        class="sharing-board-update__category category-status"
                        name="sharing-board-update__category--status"
                        required
                    >
                    ...
                    <input
                        class="sharing-board-update__category--text category-input"
                        type="text"
                ...
                <div class="sharing-board-update__info">
                    <div class="sharing-board-update__location">
                        <label
                            class="sharing-board-update__location--label"
                            for="sharing-board-update__location--input"
                            >활동 지역</label
                        >
                        <input
                            class="sharing-board-update__location--input"
                            type="text"
                            readonly
                            value="회원 주소값 넣기"
                        />
                    ...
                    <div class="sharing-board-update__price">
                        <label
                            class="sharing-board-update__price--label"
                            for="sharing-board-update__price--input"
                            >거래 가격</label
                        >
                        <input
                            class="sharing-board-update__price--input"
                            type="text"
                            readonly
                            value="무료나눔"
                        />
                ...
                <div class="sharing-board-update__title">
                    <textarea
                        class="sharing-board-update__title--textarea"
...
제목 가져오기</textarea
                ...
                <div class="sharing-board-update__content">
                    <textarea
                        class="sharing-board-update__content--textarea"
...
내용가져오기</textarea
                ...
                <div class="sharing-board-update__btn-container">
                    <a href="#none"
                        ><div class="sharing-board-update__list list--btn">
                            돌아가기
                        </div></a
                    >
                    <input
                        class="sharing-board-update__submit"
                        type="button"
                        value="수정하기"
                    />
                </div>
