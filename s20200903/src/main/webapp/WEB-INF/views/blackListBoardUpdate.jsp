            ...
            <div class="article__black-list-board-update">
                <div class="black-list-board-update__info">
                    <div class="black-list-board-update__location">
                        <label
                            class="black-list-board-update__location--label"
                            for="black-list-board-update__location--input"
                            >활동 지역</label
                        >
                        <input
                            class="black-list-board-update__location--input"
                            type="text"
                            readonly
                            value="회원 주소값 넣기"
                        />
                ...
                <div class="black-list-board-update__image">
                    <div class="black-list-board-update__image--title">
                        사진 첨부
                    </div>
                ...
                <div class="black-list-board-update__title">
                    <textarea
                        class="black-list-board-update__title--textarea"
...
제목 가져오기</textarea
                ...
                <div class="black-list-board-update__content">
                    <textarea
                        class="black-list-board-update__content--textarea"
...
내용가져오기</textarea
                ...
                <div class="black-list-board-update__btn-container">
                    <a href="#none"
                        ><div class="black-list-board-update__list list--btn">
                            돌아가기
                        </div></a
                    >
                    <input
                        class="black-list-board-update__submit"
                        type="button"
                        value="수정하기"
                    />
                </div>
