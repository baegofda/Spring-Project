            ...
            <div class="to-sharing__article-container">
                <div class="to-sharing__head-container">
                    <div class="to-sharing__sort">
                        <select
                            class="to-sharing__category"
                            name="to-sharing__category"
                        >
                    ...
                    <div class="to-sharing__head">
                        ...
                        <p class="to-sharing__sub">
                            <strong class="to-sharing__total-head"
                                >전체 글</strong
                            >
                            <!-- 불러오는 게시글 갯수불러오기 -->
                            <span class="to-sharing__count">80</span>
                        </p>
                ...
                <div class="to-sharing__content">
                    <article class="to-sharing__article">
                        <a href="toSharingBoardRead.html">
                            ...
                            <div class="to-sharing__content--text">
                                <h1 class="to-sharing__content--text__title">
                                    5단 서랍장 입니다
                                </h1>
                                <p class="to-sharing__content--text__address">
                                    서울 송파구 석촌동
                                </p>
                                <div class="to-sharing__content--text__date">
                                    ...
                                    <div class="to-sharing__content--hit">
                                        조회수 30
                                    </div>
                                </div>
