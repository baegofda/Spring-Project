			...
			<div class="to-sharing__head-container">
				...
				<div class="to-sharing__head">
					...
					<p class="to-sharing__sub">
						<strong class="to-sharing__total-head">전체
							글</strong>
						<!-- 불러오는 게시글 갯수불러오기 -->
						<span class="to-sharing__count">${pg.total}</span>
					</p>
					<a href="boardWrite.html"><div
							class="to-sharing__write">글작성</div></a>
				</div>
			</div>
				...
				<article class="to-sharing__article">
					<a href="#">  <!-- 게시글 상세!!! 링크 수정 -->
						...
						<div class="to-sharing__content--text">
							<h1 class="to-sharing__content--text__title">${Post.ptitle}</h1>
							<p class="to-sharing__content--text__address">${Post.maddr}</p>
							<div class="to-sharing__content--text__date">
								<div class="to-sharing__content--date">${Post.pdate}</div>
								<div class="to-sharing__content--hit">조회수 ${Post.phit}</div>
							</div>
							<div class="to-sharing__content--text__price">
								<div class="to-sharing__content--price">무료나눔</div>
		...
		<div class="to-sharing__page-num-container">
			<ul class="page-num-container">
				...
				<c:forEach var="i" begin="${pg.startPage}" end="${pg.endPage}">
					<a href="SearchShareList.do?sword=${sword }&currentPage=${i}">
						<li class="page-num-container__num">${i}</li>
					</a>
				</c:forEach>
				<a href="SearchShareList.do?sword=${sword }&currentPage=${i+1}">
