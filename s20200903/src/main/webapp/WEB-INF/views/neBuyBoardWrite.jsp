...
<html lang="ko">
    ...
    <body>
		...
		<form action="buyPostWrite" method="post" enctype="multipart/form-data">
			<div class="article__buy-board-write">
				...
				<div class="buy-board-write__info">
					<div class="buy-board-write__location">
						<label class="buy-board-write__location--label"
							for="buy-board-write__location--input">활동
							지역</label> <input class="buy-board-write__location--input" type="text"
							readonly value="서울 강남구" />
					</div>
					<div class="buy-board-write__price">
						<label class="buy-board-write__price--label"
							for="buy-board-write__price--input">거래
							가격</label> <input name="pprice" class="buy-board-write__price--input"
							type="text" placeholder="가격을 입력해주세요" required />
					</div>
				</div>
					...
					<div class="buy-board-write__image--container">
						<div class="image--input-container">
							<label class="image--input-label">
								...
								<input
								name="pimg1" class="image--input image-1" type="file"
								accept=".jpg, .jpeg, .png" />
							</label>
						</div>
						<div class="image--input-container">
							<label class="image--input-label">
								...
								<input
								name="pimg2" class="image--input image-2" type="file"
								accept=".jpg, .jpeg, .png" />
							</label>
						</div>
						<div class="image--input-container">
							<label class="image--input-label">
								...
								name="pimg3" class="image--input image-3" type="file"
								accept=".jpg, .jpeg, .png" />
							</label>
						</div>
						<div class="image--input-container">
							<label class="image--input-label">
								...
								name="pimg4" class="image--input image-4" type="file"
								accept=".jpg, .jpeg, .png" />
							</label>
						</div>
						<div class="image--input-container">
							<label class="image--input-label">
								...
								name="pimg5" class="image--input image-5" type="file"
								accept=".jpg, .jpeg, .png" />
							</label>
						</div>
					</div>
				...
				<div class="buy-board-write__btn-container">
					<a href="#none"><div
							class="buy-board-write__list list--btn">돌아가기</div></a> <input
						class="buy-board-write__submit" type="submit" value="작성하기" />
				</div>
			</div>
		</form>
	</article>
