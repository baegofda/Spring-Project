            ...
            <div class="article__bad-review-board-update">
                <div class="bad-review-board-update__info">
                    <div class="bad-review-board-update__location">
                        <label
                            class="bad-review-board-update__location--label"
                            for="bad-review-board-update__location--input"
                            >활동 지역</label
                        >
                        <input
                            class="bad-review-board-update__location--input"
                            type="text"
                            readonly
                            value="회원 주소값 넣기"
                        />
                ...
                <div class="bad-review-board-update__title">
                    <textarea
                        class="bad-review-board-update__title--textarea"
...
제목 가져오기</textarea
                ...
                <div class="bad-review-board-update__content">
                    <textarea
                        class="bad-review-board-update__content--textarea"
...
내용가져오기</textarea
                ...
                <div class="bad-review-board-update__btn-container">
                    ...
                    >
                    <input
                        class="bad-review-board-update__submit"
                        type="button"
                        value="수정하기"
                    />
                </div>
