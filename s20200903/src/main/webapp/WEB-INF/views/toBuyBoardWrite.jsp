        ...
        <article class="article">
            <div class="article__buy-board-write">
                <div class="buy-board-write__sort">
                    <select
                        class="buy-board-write__category"
                        name="buy-board-write__category--code"
                        required
                    >
                ...
                <div class="buy-board-write__info">
                    <div class="buy-board-write__location">
                        <label
                            class="buy-board-write__location--label"
                            for="buy-board-write__location--input"
                            >활동 지역</label
                        >
                        <input
                            class="buy-board-write__location--input"
                            type="text"
                            readonly
                            value="회원 주소값 넣기"
                        />
                    ...
                    <div class="buy-board-write__price">
                        <label
                            class="buy-board-write__price--label"
                            for="buy-board-write__price--input"
                            >거래 가격</label
                        >
                        <input
                            class="buy-board-write__price--input"
                            type="text"
                ...
                <div class="buy-board-write__title">
                    <textarea
                        class="buy-board-write__title--textarea"
                ...
                <div class="buy-board-write__btn-container">
                    <a href="#none"
                        ><div class="buy-board-write__list list--btn">
                            돌아가기
                        </div></a
                    >
                    <input
                        class="buy-board-write__submit"
                        type="button"
                        value="작성하기"
                    />
                </div>
