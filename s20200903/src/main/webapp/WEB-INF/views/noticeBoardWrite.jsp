            ...
            <div class="article__notice-board-write">
                <div class="notice-board-write__info">
                    <div class="notice-board-write__location">
                        <label
                            class="notice-board-write__location--label"
                            for="notice-board-write__location--input"
                            >활동 지역</label
                        >
                        <input
                            class="notice-board-write__location--input"
                            type="text"
                            readonly
                            value="회원 주소값 넣기"
                        />
                ...
                <div class="notice-board-write__image">
                    <div class="notice-board-write__image--title">
                        사진 첨부
                    </div>
                ...
                <div class="notice-board-write__title">
                    <textarea
                        class="notice-board-write__title--textarea"
                ...
                <div class="notice-board-write__content">
                    <textarea
                        class="notice-board-write__content--textarea"
                ...
                <div class="notice-board-write__btn-container">
                    <a href="#none"
                        ><div class="notice-board-write__list list--btn">
                            돌아가기
                        </div></a
                    >
                    <input
                        class="notice-board-write__submit"
                        type="button"
                        value="작성하기"
                    />
                </div>
