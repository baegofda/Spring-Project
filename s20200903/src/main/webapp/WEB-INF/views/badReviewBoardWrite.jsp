            ...
            <div class="article__bad-review-board-write">
                <div class="bad-review-board-write__info">
                    <div class="bad-review-board-write__location">
                        <label
                            class="bad-review-board-write__location--label"
                            for="bad-review-board-write__location--input"
                            >활동 지역</label
                        >
                        <input
                            class="bad-review-board-write__location--input"
                            type="text"
                            readonly
                            value="회원 주소값 넣기"
                        />
                ...
                <div class="bad-review-board-write__image">
                    <div class="bad-review-board-write__image--title">
                        사진 첨부
                    </div>
                ...
                <div class="bad-review-board-write__title">
                    <textarea
                        class="bad-review-board-write__title--textarea"
                ...
                <div class="bad-review-board-write__content">
                    <textarea
                        class="bad-review-board-write__content--textarea"
                ...
                <div class="bad-review-board-write__btn-container">
                    <a href="#none"
                        ><div class="bad-review-board-write__list list--btn">
                            돌아가기
                        </div></a
                    >
                    <input
                        class="bad-review-board-write__submit"
                        type="button"
                        value="작성하기"
                    />
                </div>
