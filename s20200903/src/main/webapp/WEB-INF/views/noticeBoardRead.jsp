            ...
            <div class="article__notice-board-read">
                ...
                <div class="notice-board-read__info-container">
                    <div class="notice-board-read__info">
                        <a href="#none"
                            ><div class="notice-board-read__name">
                                관리자
                            </div></a
                        >
                        <p class="notice-board-read__address">
                            서울특별시 송파구 석촌동
                        </p>
                    </div>
                </div>
                <div class="notice-board-read__content">
                    <h1 class="notice-board-read__content--title">
                        제목이 들어갑니다.
                    </h1>
                ...
                <div class="notice-board-read__btn-container">
                    <a href="#none"
                        ><div class="notice-board-read__list list-btn">
                            목록
                        </div></a
                    >
                    <input
                        class="notice-board-read__delete"
                        type="button"
                        value="삭제"
                    />
                    <input
                        class="notice-board-read__update"
                        type="button"
                        value="수정"
                    />
                </div>
