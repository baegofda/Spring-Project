...
<html lang="ko">
    ...
    <body>
        ...
        <article class="article">
            <div class="article__black-list-board-read">
                ...
                <div class="black-list-board-read__info-container">
                    <div class="black-list-board-read__info">
                        <a href="#none"
                            ><div class="black-list-board-read__name">
                                작성자
                            </div></a
                        >
                        <p class="black-list-board-read__address">
                            서울특별시 송파구 석촌동
                        </p>
                    </div>
                </div>
                <div class="black-list-board-read__content">
                    <h1 class="black-list-board-read__content--title">
                        제목이 들어갑니다.
                    </h1>
                    <div class="black-list-board-read__content--hits">
                        2020.09.23 · 조회수 46
                    </div>
                ...
                <div class="black-list-board-read__btn-container">
                    <a href="#none"
                        ><div class="black-list-board-read__list list-btn">
                            목록
                        </div></a
                    >
                    <input
                        class="black-list-board-read__delete"
                        type="button"
                        value="삭제"
                    />
                    <input
                        class="black-list-board-read__update"
                        type="button"
                        value="수정"
                    />
                </div>
